        ...
        <div className='m-auto container grid grid-cols-3 py-10 text-white justify-center'>
            <div className="stats overflow-hidden">
                <div className="stat text-center">
                    ...
                    <div className="stat-desc  text-xl md:text-2xl text-white">Active User</div>
                </div>
            </div>
            <div className="stats  overflow-hidden">
                <div className="stat text-center">
                    ...
                    <div className="stat-desc  text-xl md:text-2xl text-white">Premium Tools</div>
                </div>
            </div>
            <div className="stats overflow-hidden">
                <div className="stat text-center">
                    ...
                    <div className="stat-desc  text-xl md:text-2xl text-white">Ratings</div>
                </div>
            </div>
        </div>
    );
